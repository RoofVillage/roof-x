...
class RollerColumnPickerVerticalFloatingArtboard<T>
    extends EmptyVerticalFloatingArtboard<TitledOptionData<T>> with RollerColumnPickerArtboardBuilder<T> {
...
class _RollerColumnPickerVerticalFloatingArtboardState<T>
  ...
  @override
  set selectedValue(TitledOptionData<T> newSelectedValue) {
